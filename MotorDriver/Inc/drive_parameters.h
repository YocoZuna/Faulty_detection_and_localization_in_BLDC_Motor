...
#define MAX_APPLICATION_SPEED_RPM       10500 /*!< rpm, mechanical */
...
#define SPEED_THRESHOLD_DEMAG    ((uint32_t) 7000)  /*!< Speed threshold above which the RUN_DEMAGN_DELAY_MIN is applied */
...
/* Speed control loop */
#define SPEED_LOOP_FREQUENCY_HZ       ( uint16_t )7.874015748031496 /*!<Execution rate of speed
                                                      regulation loop (Hz) */

#define PID_SPEED_KP_DEFAULT          1133/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          297/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PERIODMAX                      (uint16_t) (PWM_PERIOD_CYCLES * 100 / 100)
